...
public class IRBasicBlock implements IRSourceInfo {
    ...
    /**
     * Returns a list containing successors
     * @return
     */
    public List<IRIdentifier> getSuccessorBlocks() {
        return switch(this.exitInstruction.getOp()) {
            case JCC    -> List.of(this.exitInstruction.getTrueTargetBlock(), this.exitInstruction.getFalseTargetBlock());
            case JMP    -> List.of(this.exitInstruction.getTrueTargetBlock());
            case RET    -> List.of();
        };
    }
